...
export default function CinemaQuotePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Request Cinema Quote</h1>
      <Card>
        <CardHeader>
          <CardTitle>Cinema Quote Request Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Please describe your cinema project..."
                required
              />
            </div>
            <div>
