...
export default function SoftwareQuotePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Request Software Quote</h1>
      <Card>
        <CardHeader>
          <CardTitle>Software Quote Request Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="projectType">Software Type</Label>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Please describe your software project..."
                required
              />
            </div>
            <div>
