...
export default function AudioQuotePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Request Audio Quote</h1>
      <Card>
        <CardHeader>
          <CardTitle>Audio Quote Request Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="projectType">Audio Service Type</Label>
              <Select value={projectType} onValueChange={setProjectType}>
                <SelectTrigger>
                  <SelectValue placeholder="Select audio service type" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Please describe your audio project..."
                required
              />
            </div>
            <div>
