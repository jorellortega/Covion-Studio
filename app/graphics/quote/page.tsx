...
export default function GraphicsQuotePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Request Graphics Quote</h1>
      <Card>
        <CardHeader>
          <CardTitle>Graphics Quote Request Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="projectType">Graphics Type</Label>
              <Select value={projectType} onValueChange={setProjectType}>
                <SelectTrigger>
                  <SelectValue placeholder="Select graphics type" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Please describe your graphics project..."
                required
              />
            </div>
            <div>
