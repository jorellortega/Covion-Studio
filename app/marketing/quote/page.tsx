...
export default function MarketingQuotePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Request Marketing Quote</h1>
      <Card>
        <CardHeader>
          <CardTitle>Marketing Quote Request Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="projectType">Marketing Type</Label>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                placeholder="Please describe your marketing project..."
                required
              />
            </div>
            <div>
